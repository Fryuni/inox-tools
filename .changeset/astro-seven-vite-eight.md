...
"@inox-tools/server-islands": patch
"@inox-tools/sitemap-ext": patch
"@inox-tools/star-warp": patch
---

Adds support for Astro 7 and Vite 8 while retaining support for previously compatible versions. `@inox-tools/star-warp` also adds support for Starlight 0.41.
